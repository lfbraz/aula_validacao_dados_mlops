...
Opening a pull request will trigger a[workflow](../.github/workflows/validacao_dados_aula_8-run-tests.yml) 
...
Links:
* [Staging model in UC](https://dbc-a267a1ed-0d96.cloud.databricks.com/explore/data/models/staging/validacao_dados_aula_8/validacao_dados_aula_8-model)
* [Prod model in UC](https://dbc-a267a1ed-0d96.cloud.databricks.com/explore/data/models/prod/validacao_dados_aula_8/validacao_dados_aula_8-model)
. 
