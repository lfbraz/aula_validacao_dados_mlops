...
git add README.md docs .gitignore validacao_dados_aula_8/resources/README.md
...
* You must be a Databricks workspace admin in the staging and prod workspaces. 
  ...
  [staging workspace admin console](https://dbc-a267a1ed-0d96.cloud.databricks.com#setting/accounts) and
  [prod workspace admin console](https://dbc-a267a1ed-0d96.cloud.databricks.com#setting/accounts). 
...
If you want to use different catalog names, please update the target names declared in the[validacao_dados_aula_8/databricks.yml](../validacao_dados_aula_8/databricks.yml) file.
...
Follow the instructions in [validacao_dados_aula_8/resources/README.md](../validacao_dados_aula_8/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../validacao_dados_aula_8/resources/README.md)  to propose, test, and deploy
